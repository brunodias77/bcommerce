...
public class CreateProductCommandValidator : AbstractValidator<CreateProductCommand>
{
    ...
    public CreateProductCommandValidator(CatalogDbContext context)
    {
        _context = context;
    ...
    private async Task<bool> BeUniqueBaseSku(string baseSku, CancellationToken cancellationToken)
    {
        return !await _context.Products
            .AnyAsync(p => p.BaseSku == baseSku, cancellationToken);
    }
    ...
    private async Task<bool> BrandExists(Guid brandId, CancellationToken cancellationToken)
    {
        return await _context.Brands
            .AnyAsync(b => b.BrandId == brandId, cancellationToken);
    }
}